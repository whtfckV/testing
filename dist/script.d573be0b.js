...
(function () {
  var quotesList = document.querySelector('#quotes-from-others');
  var btnNewQuote = document.querySelector('#btnNewQuote');
  btnNewQuote.addEventListener('click', function () {
    ...
    fetch(url).then(function (response) {
      ...
      quoteAuthor.innerHTML = "&copy; ".concat(data.quoteAuthor || 'Неивестный автор');
...
},{}],"../../../.nvm/versions/node/v19.2.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v19.2.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script.js"], null)
